...
<body>
    <main>
        <?php
            ...
            $consultaSQL = "SELECT * FROM Platillo WHERE idCategoria = 6 ORDER BY nombrePlatillo";
                ...
                while ($fila = $resultado->fetch_assoc()) {
                    ...
                    echo '
                        <div class="elemento">
                            ...
                            <p>Categoria: Especial<br>'. $mensajeP . '<br>Descripción: ' . $fila['descripcionPlatillo'] . '</p>
