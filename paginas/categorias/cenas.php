...
<body>
    <main>
        <?php
            ...
            $consultaSQL = "SELECT * FROM Platillo WHERE idCategoria = 5 ORDER BY nombrePlatillo";
                ...
                while ($fila = $resultado->fetch_assoc()) {
                    ...
                    echo '
                        <div class="elemento">
                            ...
                            <p>Categoria: Cena<br>'. $mensajeP . '<br>Descripción: ' . $fila['descripcionPlatillo'] . '</p>
                            <div class="cont-boton">
                                <form method="POST" action="../platillo.php">
                                    <input type="hidden" name="nombrePlatillo" value="' . $fila['nombrePlatillo'] . '">
                                    <input type="hidden" name="nombreCategoria" value="Cena">
