...
<body>
    <main>
        <?php
            ...
            $consultaSQL = "SELECT * FROM platillo WHERE idCategoria = 2 ORDER BY nombrePlatillo";
                ...
                while ($fila = $resultado->fetch_assoc()) {
                    ...
                    echo '
                        <div class="elemento">
                            ...
                            <p>Categoria: Comida<br>'. $mensajeP . '<br>Descripción: ' . $fila['descripcionPlatillo'] . '</p>
                            <div class="cont-boton">
                                <form method="POST" action="../platillo.php">
                                    <input type="hidden" name="nombrePlatillo" value="' . $fila['nombrePlatillo'] . '">
                                    <input type="hidden" name="nombreCategoria" value="Comida">
